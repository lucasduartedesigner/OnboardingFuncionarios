    ...
    <div class="main-body p-0">
        ...
        <div class="inner-main ">
              ...
              <div class="inner-main-header justify-content-end"> 
                  ...
                  <form class="d-flex ">                                 
                      <input type="text" class="form-control bg-gray-200 border-gray-200 shadow-none mb-4 mt-4" placeholder="Digite sua busca"/>
                      <button type="button" class="btn btn-success mb-4 mt-4 " data-bs-toggle="modal" data-bs-target="#modalTarefa" Small button >Buscar</button>
                  </form>
                  </span>
              </div>
              <!-- /Inner main header -->
